...
public class TokenGenerator {
	...
	public String getToken() {
		...
		final String clientId = "4tlrem51smu8m3hg26deon9hoh";
		final String userPoolId = "us-east-1_6qFmqyEYn";
		...
		initiateAuthRequest.addAuthParametersEntry("USERNAME", "plarentis");
